        ...
        <div className="flex items-center gap-3">
          ...
          <div
            className={clsx(
              ...
              'flex items-center justify-center text-center text-sm leading-none select-none',
              isError
                ? 'border-red-400/20 bg-red-400/5 text-red-300'
                : 'border-green-400/20 bg-green-400/5 text-green-300',
            )}
            onMouseDown={handleStartHiddenReset}
            onMouseUp={clearResetTimeout}
            onMouseLeave={clearResetTimeout}
            onTouchStart={handleStartHiddenReset}
            onTouchEnd={clearResetTimeout}
            onTouchCancel={clearResetTimeout}
          >
